...
chrome.webRequest.onBeforeRequest.addListener(
  function (details) {
    ...
    // The returned data is NOT a webRequest.BlockingResponse type data,
    // will cause error on Chrome Version 87 88 90
    // - https://github.com/justjavac/ReplaceGoogleCDN/issues/64#issuecomment-839610913
    // - https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/webRequest/onBeforeRequest
    //
    // If we need to deal with the CSP, we must return
    // the right data type but not simple a url string.
